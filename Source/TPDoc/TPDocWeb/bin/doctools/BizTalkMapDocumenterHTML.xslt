	...
	<xsl:template name="ProcessFunctoid">
		...
		<span class="functoidName">
			<xsl:choose>
				...
				<xsl:when test="$functoidNode/@Functoid-FID = '312'">Greater Than or Equeal To</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '313'">Less Than</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '314'">Less Than or Equeal To</xsl:when>
				...
				<xsl:when test="$functoidNode/@Functoid-FID = '706'">IsNill</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '122'">AddDays</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '123'">Date</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '124'">Time</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '125'">Date and Time</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '524'">Database Lookup</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '574'">Value Extractor</xsl:when>
				...
				<xsl:when test="$functoidNode/@Functoid-FID = '326'">Cumulative Min</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '327'">Cumulative Max</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '328'">Cumulative Concatincate</xsl:when>
				<xsl:when test="$functoidNode/@Functoid-FID = '260'">Scrippting</xsl:when>
				...
				<xsl:when test="$functoidNode/@Functoid-FID = '374'">Value Mapping (Flattering)</xsl:when>
				...
				<xsl:when test="$functoidNode/@Functoid-FID = '7901'">Get SSO Value</xsl:when> 
				<xsl:otherwise>Unknown Functoid</xsl:otherwise>
			</xsl:choose>
		</span>
